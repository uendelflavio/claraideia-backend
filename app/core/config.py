...
PROJECT_DESCRIPTION = os.getenv("PROJECT_DESCRIPTION", "Api Restfull Start-up Claraideia.")
...
if not MONGODB_URL:
    ...
    MONGO_PASS = os.getenv("MONGO_PASSWORD", "1817698")
    MONGO_DB = os.getenv("MONGO_DB", "claraideia")
